 ...
 * 
 */
@WebServiceClient(name = "StudentPortService", targetNamespace = "http://in28minutes.com/students", wsdlLocation = "http://localhost:8080/ws/students.wsdl")
public class StudentPortService
    extends Service
{

    private static final URL STUDENTPORTSERVICE_WSDL_LOCATION;
    private static final WebServiceException STUDENTPORTSERVICE_EXCEPTION;
    private static final QName STUDENTPORTSERVICE_QNAME = new QName("http://in28minutes.com/students", "StudentPortService");
    ...
    public StudentPort getStudentPortSoap11() {
        return super.getPort(new QName("http://in28minutes.com/students", "StudentPortSoap11"), StudentPort.class);
    }
    ...
    public StudentPort getStudentPortSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://in28minutes.com/students", "StudentPortSoap11"), StudentPort.class, features);
    }
